...
class SAIControlSystem final : public ISystemBase
{
public:
    void Update(float InDeltaTime) override
    {
        ...
        ArchetypeManager->Query<ECS::CVelocity, ECS::CAIInput>(
            [](ECS::Entity e, ECS::CVelocity& Velocity, const ECS::CAIInput& Input)
            {
